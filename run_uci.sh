...
PRETRAIN_NAME="uci_pt_${TS}_${PT_TAG}${TAG:+_$TAG}"
FINETUNE_NAME="uci_ft_${TS}_${FT_TAG}${TAG:+_$TAG}"
...
GROUP="uci_${TS}_${PT_TAG}${TAG:+_$TAG}"
...
export OUTBASE="${OUTBASE:-output/uci_infer_${TS}${TAG:+_$TAG}}"
